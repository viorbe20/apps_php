        <!--Login form-->
        <form action="" method="post" name='form_login' id='form_login' class='d-flex text-white align-items-end mx-4'>
            <!--User group-->
            <div class="form-group d-flex justify-content-center align-items-center p-1 mx-0">
                ...
                <div class="d-flex p-1 justify-content-center align-items-center">
                    <input type="text" class="form-control mx-1" name="username" id="username" autocomplete="on">
                </div>
            </div>
            <!--Password group-->
            <div class="form-group d-flex justify-content-center align-items-center p-1 mx-0">
